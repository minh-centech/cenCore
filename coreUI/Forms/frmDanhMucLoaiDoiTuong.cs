...
namespace coreUI.Forms
{
    public partial class frmDanhMucLoaiDoiTuong : coreBase.BaseForms.frmBaseDanhMuc
    {
        ...
        protected override void DeleteDanhMuc()
        {
            ...
            {
                deleteAction = new Action(() => { coreUI.DanhMuc.Delete(null, new Func<bool>(() => DanhMucLoaiDoiTuongBUS.Delete(new DanhMucLoaiDoiTuong() { ID = ug.ActiveRow.Cells["ID"].Value })), ug, bsDanhMuc); });
                base.DeleteDanhMuc();
            }
        }
    }
